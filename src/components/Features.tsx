...
const Features = () => {
  const features = [
    {
      icon: <Shield className="h-8 w-8 text-investment-accent" />,
  ...
  return (
    <section id="features" className="container-section bg-gray-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {features.map((feature, index) => (
          <div 
            key={index} 
            className="card-investment flex flex-col items-start hover:translate-y-[-5px]"
          >
