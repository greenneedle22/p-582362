    ...
    <footer className="bg-investment-dark text-white pt-16 pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-bold mb-4">InvestCore</h3>
            <p className="text-gray-300 mb-4">
              A professional investment platform built for the modern investor, combining security and innovation.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#staking" className="text-gray-300 hover:text-white transition-colors">Staking</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2023 InvestCore. All rights reserved.
            </p>
